  ...
  columns: [
    ...
    },
    {
      ...
      render: (data, type, row, meta) => {
        if (type === "display") {
          return `<input onchange="update_tt('${row.id}', this.value, 0, this)"  value="${data}" />`;
        }
        return data;
      },
    },
    {
      ...
      render: (data, type, row, meta) => {
        if (type === "display") {
          return `<input onchange="update_tt('${row.id}', this.value, 1, this)"  value="${data}" />`;
        }
        return data;
      },
    },
